...
static std::vector<std::unique_ptr<test_case>> make_test_cases_eval() {
    ...
    test_cases.emplace_back(new test_im2col(GGML_TYPE_F16, GGML_TYPE_F16, GGML_TYPE_F16));
    test_cases.emplace_back(new test_im2col(GGML_TYPE_F16, GGML_TYPE_F16, GGML_TYPE_F32));
